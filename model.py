...
from torch_geometric.nn import ResGatedGraphConv, GATv2Conv
...
class Model(torch.nn.Module):
    def __init__(self):
        super().__init__()
        self.conv1 = GATv2Conv(IMG_SIZE*IMG_SIZE, featurelength * 2, heads=4)
        self.conv2 = ResGatedGraphConv(featurelength * 4, featurelength * 2)
        
        self.fc1 = nn.Linear(featurelength, OUT)
        
        self.dropout = nn.Dropout(0.15)
        self.pool = nn.MaxPool1d(2)
        
        self.bn1 = nn.BatchNorm1d(featurelength * 2)
